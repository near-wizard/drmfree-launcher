// Placeholder root for the "Mod Manager" plugin window (decision 0027).
...
// src-tauri/capabilities/plugin-mods.json) before decision 0026's
  ...
  return (
    <main className="container plugin-window">
      ...
      <p className="header-subtitle">
        ...
        mod-management commands wired up yet. See <code>docs/decisions/0026</code> and{" "}
        <code>0027</code> in the launcher repo for what's planned and why nothing installs
        anything yet.
      </p>
    </main>
  );
